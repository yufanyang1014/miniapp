...
__DEFINE__(1566284108127, function(require, module, exports) {
module.exports = require('./demo/utils')
}, function(modId) {var map = {"./demo/utils":1566284108128}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1566284108128, function(require, module, exports) {
...
// id to ctx
function barc(ctx, code, width, height, target) {
	barcode.code128(ctx, code, convert_length(width), convert_length(height))
}
// id to ctx
function qrc(ctx, code, width, height, target) {
...
}, function(modId) { var map = {"./barcode":1566284108129,"./qrcode":1566284108130}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1566284108129, function(require, module, exports) {
var CHAR_TILDE = 126;
var CODE_FNC1 = 102;
...
__DEFINE__(1566284108130, function(require, module, exports) {
var QR = (function () {
...
return __REQUIRE__(1566284108127);
})()
